This project was created using React/Redux, React Router, redux-thunk middleware, desingned using pure CSS and bootstrapped with [Create React App](https://github.com/facebook/create-react-app).
